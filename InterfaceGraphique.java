...
public class InterfaceGraphique {
	...
	public static void pressKey() {
		try {
			...
			DrawEnvironnement.draw(DrawEnvironnement.nbLevelIni1, DrawEnvironnement.nbLevelIni2, DrawEnvironnement.nbLevelIni3,false);
			...
			StdDraw.picture(1, Caracters.getY1(),
		    	...
		    	StdDraw.picture(1, Caracters.getY1(),
						"C:\\Users\\Yann-Ly\\eclipse-workspace\\VideoGame\\src\\ImageGame\\plongeur.jpg", 0.2, DrawEnvironnement.tailleNiv1 - 0.01);
		    } else if (-1.3 < Caracters.getY1() && Caracters.getY1() < 0.7) {
		    	StdDraw.picture(1, Caracters.getY1(),
						"C:\\Users\\Yann-Ly\\eclipse-workspace\\VideoGame\\src\\ImageGame\\plongeur.jpg", 0.2, DrawEnvironnement.tailleNiv2 - 0.01);
		    } else if (-3 < Caracters.getY1() && Caracters.getY1() < -1.3) {
		    	StdDraw.picture(1, Caracters.getY1(),
						"C:\\Users\\Yann-Ly\\eclipse-workspace\\VideoGame\\src\\ImageGame\\plongeur.jpg", 0.2, DrawEnvironnement.tailleNiv3 - 0.01);
		    } 
			Thread.sleep(500);
	...
	public static void main(String[] args) {
		...
		StdDraw.setYscale(-3 - WIDTH, X_MAX + WIDTH);
		StdDraw.picture(0, 0,
				"C:\\Users\\Yann-Ly\\eclipse-workspace\\VideoGame\\src\\ImageGame\\fond marin jeu java2.jpg", 6.3, 6.3);
		...
		//StdDraw.filledCircle(1, 0.9, 0.1);
		DrawEnvironnement.draw(DrawEnvironnement.nbLevelIni1,DrawEnvironnement.nbLevelIni2,DrawEnvironnement.nbLevelIni3, true);
